...
module mem_wb_reg (
    ...
    always @(posedge clk or posedge rst) begin
        if (rst) begin
            ...
            if (clr) begin
                wb_RegWrite <= 1'b0; wb_MemtoReg <= 3'b0; wb_read_data <= 32'b0;
                wb_alu_result <= 32'b0; wb_pc_plus_4 <= 32'b0; wb_imm_ext <= 32'b0; 
                wb_branch_target <= 32'b0; wb_is_ecall <= 1'b0; wb_is_mret <= 1'b0; 
                wb_is_ebreak <= 1'b0; wb_pc <= 32'b0; wb_csr_we <= 1'b0; 
                wb_csr_addr <= 12'b0; wb_csr_wdata <= 32'b0; wb_csr_rdata <= 32'b0;
