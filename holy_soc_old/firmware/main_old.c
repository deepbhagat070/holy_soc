...
#define AES_KEY     ((volatile uint32_t*) 0x50000000)
#define AES_TEXT    ((volatile uint32_t*) 0x50000010)
#define AES_START   ((volatile uint32_t*) 0x50000020)
#define AES_DONE    ((volatile uint32_t*) 0x50000024)
#define AES_RESULT  ((volatile uint32_t*) 0x50000028)
